...
class CashDrawerEntry(Base):
    ...
    session_id: Mapped[int | None] = mapped_column(ForeignKey("cash_drawer_sessions.id"), nullable=True, index=True)
    ...
    session: Mapped["CashDrawerSession | None"] = relationship("CashDrawerSession", back_populates="entries")
