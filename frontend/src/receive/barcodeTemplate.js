...
export function normalizeBarcodeTemplate(input) {
  ...
  return {
    ...
    textScale: clamp(asNum(raw.textScale, defaultBarcodeTemplate.textScale), 0.4, 2),
    ...
    doubleTextScale: clamp(asNum(raw.doubleTextScale, defaultBarcodeTemplate.doubleTextScale), 0.4, 2),
